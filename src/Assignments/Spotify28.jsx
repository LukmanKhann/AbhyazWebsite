import design from "./spotify.module.css";
const Spotify = () => {
  return (
    <div>
      ...
      <section id={design.body}>
        <div id={design.underdiv}>
          <div id={design.mobile}>
            <div id={design.mobilee}>
              
            </div>
          </div>

          <div id={design.heading}>
            <div id={design.headingg}>
                
                <button id={design.btn}>GET SPOTIFY FREE</button>
            </div>
          </div>
        </div>
